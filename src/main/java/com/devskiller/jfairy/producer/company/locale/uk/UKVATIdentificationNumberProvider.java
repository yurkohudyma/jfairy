package com.devskiller.jfairy.producer.company.locale.uk;
 ...
 */
public class UKVATIdentificationNumberProvider implements VATIdentificationNumberProvider {

	private static final Logger LOG = LoggerFactory.getLogger(UKVATIdentificationNumberProvider.class);
	...
	@Inject
	public UKVATIdentificationNumberProvider(BaseProducer baseProducer) {
