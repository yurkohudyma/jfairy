 ...
 */
public class UkNationalIdentityCardNumberProvider implements NationalIdentityCardNumberProvider {
	...
	@Inject
	public UkNationalIdentityCardNumberProvider(DateProducer dateProducer, BaseProducer baseProducer) {
